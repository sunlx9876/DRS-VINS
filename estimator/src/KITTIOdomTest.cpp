...
int main(int argc, char** argv)
{
	...
	if(argc != 3)
	{
		printf("please intput: rosrun drs_vins drs_kitti_odom_test [config file] [data folder] \n"
			   "for example: rosrun drs_vins drs_kitti_odom_test "
			   "~/catkin_ws/src/DRS-VINS/config/kitti_odom/kitti_config00-02.yaml "
